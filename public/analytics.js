...
function applyLoadedIndicatorPreferences(prefs) {
  ...
  if (prefs.volOverlayMode) {
    ...
    else if (prefs.toggles.vol || prefs.toggles.volume) state.volOverlayMode = 'simple';
...
// ==============================================================
// MASTER ADMIN CONSOLE LOGIC & UNIVERSE / DOCS CONTROLLER
// ==============================================================
...
function updateExploreSyncSignal(status, message) {
